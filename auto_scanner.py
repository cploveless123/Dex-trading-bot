...
from trading_constants import (
    MIN_MCAP, MAX_MCAP, MIN_5MIN_VOLUME,
    MIN_HOLDERS, POSITION_SIZE, TICKER_BLACKLIST, MAX_OPEN_POSITIONS,
    SIM_RESET_TIMESTAMP, ATH_DIVERGENCE_REJECT, OLD_PUMP_5M_THRESHOLD
)
...
def check_should_buy(addr, p, sym, dex, m, v, v5, bs, buys, sells, holders, pair_addr):
    ...
    if pair_age_min < 30 and chg60 > 0 and chg5 / chg60 > 0.15:
        return False, f"chg5 {chg5:.1f}% / h1 {chg60:.0f}% = {chg5/chg60*100:.0f}% (parabolic - <30min)"
