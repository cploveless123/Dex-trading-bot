...
MAX_MCAP = 35000             # Maximum market cap in USD
...
TP1_TRAIL = 35               # 35% trailing stop from peak
TP1_HOLD = True              # HOLD at TP1 - no sell
TP1_SELL_PCT = 0             # 0% sell at TP1 (HOLD mode)

TP2_PCT = 90                # Take profit 2: +90%
TP2_SELL_PCT = 0.30         # Sell 30% of position at TP2
TP2_TRAIL = 35              # 35% trailing stop from peak

TP3_PCT = 200               # Take profit 3: +200%
TP3_SELL_PCT = 0.40         # Sell 40% of position at TP3
TP3_TRAIL = 35              # 35% trailing stop from peak

TP4_PCT = 300               # Take profit 4: +300%
TP4_SELL_PCT = 0.20         # Sell 20% of position at TP4
TP4_TRAIL = 35              # 35% trailing stop from peak

TP5_PCT = 1000              # Take profit 5: +1000% (TP5 target!)
TP5_SELL_PCT = 1.0         # Sell ALL (100%) of position at TP5
TP5_TRAIL = 20              # 20% trailing stop from peak (tight — protect gains)
